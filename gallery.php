...
<head>
    ...
    <style>
        ...
        :root {
            --color-primary-bg: #fefcfb; /* Soft white/cream background */
            --color-accent-pink: #ff69b4; /* Hot Pink (Kawaii pink) */
            --color-accent-pastelpink: #ffb8dc; /* Hot Pink (Kawaii pink) */
        ...
        body::before {
            ...
            /* loading gif */
            background-image: url("https://www.lucylooandroo.com/cdn/shop/t/6/assets/loading.gif?v=135655685998696985211639013649");
        ...
        @media (prefers-reduced-motion: reduce) {
            body::before {
            animation: loaderHoldFadeReduced 10ms linear forwards;
            }
        ...
        .btn-commission {
            ...
            box-shadow: 0 4px 0 0 #e84c94; /* Darker pink for 'pop' effect */
        }
        .btn-commission:hover {
            transform: translateY(-2px);
            box-shadow: 0 6px 0 0 #e84c94;
        }
        .btn-commission:active {
            transform: translateY(2px);
            box-shadow: 0 0 0 0 #e84c94;
        }
...
<!-- FLOATING FIXED DECORATION IMAGE -->
    <div class="fixed top-10 left-1/2 -translate-x-1/2 z-50 hidden md:block">
        <!-- The <a> tag creates the link -->
        <a href="./Homepage.html#commissions" title="Home"> 
            <div class="rounded-full">
                 ...
                 *** YOUR PUBLIC GOOGLE DRIVE IMAGE URL IS NOW HERE ***
                 ...
                 <img src="https://static.wixstatic.com/media/628285_fd030053b925402b995229b905418ab0~mv2.png/v1/fill/w_190,h_170,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/Ribbon.png"
                      onerror="this.onerror=null; this.src='https://placehold.co/80x80/FFF0F5/DB2777?text=💖'" 
                      alt="Floating Decor Image"
                      class="rounded-full w-20 h-20 object-cover">
            </div>
        </a>
    </div>
    <!-- END FLOATING FIXED DECORATION IMAGE -->
<!-- BANNER IMAGE SECTION (Now Fixed and Attached Directly Under Header) -->
    <!-- We calculate the exact position: Header starts at top-4, has padding/height ~16 units, so banner starts at top-20. -->
    <div class="fixed top-0 z-10 hidden md:block">
        <div class="w-full max-w-9xl mx-auto px-8">
            <div class="relative w-full overflow-hidden">
                 ...
                 <img id="floating-image"
                      src="https://drive.google.com/thumbnail?id=1obezkjBLRmULBqtYXxEO179psLlSpT9F&sz=s800"
...
<body class="antialiased">
    ...
    <h1 class="text-3xl font-fredoka font-bold text-pink-accent tracking-wide">
        <a href="./Homepage.html#commissions" title="Home"> 
                The Candie Box <span class="text-xl">ʚ ♡ ɞ</span>
            </h1>
        </a>
            <nav class="hidden sm:block">
    <span class="text-lg font-medium text-pink-600 cursor-default mx-3 transition duration-150" aria-current="page">Gallery</span>
    <a href="#commissions" class="text-lg font-medium text-gray-600 hover:text-pink-accent mx-3 transition duration-150">Commissions</a>
    <a href="#contact" class="text-lg font-medium text-gray-600 hover:text-pink-accent mx-3 transition duration-150">Contact</a>
</nav>
    </div>
    </header>
    <!-- Top pink social bar -->
    <div id="top-social-bar" class="w-full bg-pink-accent text-white fixed top-0 left-0 z-30">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-9 flex items-center justify-end space-x-4">
            <a href="mailto:candycute551@gmail.com" class="text-sm font-medium hover:underline" aria-label="Email">✉️ Email</a>
            <a href="https://twitter.com/candie_cake" target="_blank" rel="noopener" class="text-sm font-medium hover:underline" aria-label="Twitter">🐦 Twitter</a>
            <a href="https://instagram.com/candie__cake" target="_blank" rel="noopener" class="text-sm font-medium hover:underline" aria-label="Instagram">📸 Instagram</a>
        </div>
    </div>
    ...
    <main>
        <!-- Header -->
        <div class="header">
          <h1 class="text-4xl font-fredoka font-extrabold text-gray-900">GALLERY</h1>
          <p class="mt-3 text-lg text-gray-600">♡newest to oldest works♡</p>
        </div>

        <!-- ✨ PHP-Generated Image Grid ✨ -->
        <div class="row"> 
            <?php
            // 1. Define the path to your gallery folder.
            $folder_path = 'img/Gallery/';

            // 2. Find all image files in that folder.
            // You can add more extensions here like 'gif', 'jpeg', etc.
            $files = glob($folder_path . '*.{jpg,jpeg,png,gif}', GLOB_BRACE);

            // 3. Create an array to store file info (path and date).
            $images = [];
            ...
            // 4. Sort the array by the timestamp, from newest to oldest.
            arsort($images);

            // 5. Loop through the sorted array and generate the HTML for each image.
            foreach ($images as $image_path => $timestamp) {
                echo '<div class="column">';
                echo '  <img src="' . htmlspecialchars($image_path) . '" style="width:100%">';
                echo '</div>';
            }
            ?>
        </div>
...
<!-- We calculate the exact position: Header starts at top-4, has padding/height ~16 units, so banner starts at top-20. -->
    ...
    <!-- end back button -->
    <div class="w-full max-w-9xl mx-auto px-8">
        <div class="relative w-full overflow-hidden rounded-t-xl"></div>
    <footer>
        <!-- FOOTER IMAGE SECTION (Now Fixed and Attached Directly Under Header) -->
        ...
        <!--
         ...
         <img id="floating-image"
              ...
              onerror="this.onerror=null; this.src='https://placehold.co/1200x200/F472B6/DB2777?text=Cute+Banner+Image+Placeholder'" 
              alt="Decorative Banner Image"
              class="object-cover z-0 rounded-t-xl" style="position: fixed; left: 0; bottom: -35px; width: 100vw; height: 8rem;">
        </div>
    </div>
    </div>
...
// --- ✨ Flowy Heart Trail Cursor Logic ✨ ---
let trailCounter = 0;
...
document.addEventListener('mousemove', (e) => {
    ...
    createTrailElement(x, y, 'heart-trail', '♡', 3.5); 
    }
});

// --- ✨ Heart Click Effect ✨ ---
document.addEventListener('click', (e) => {
    // Don't create a heart if a button, link, or gallery item was clicked
    if (e.target.closest('a, button, .column img, .column video, .modal-content, .close')) {
        return;
    }
